...
import { Burger, Divider, Flex, AppShell as MantineAppShell, ScrollArea, Text, Title } from "@mantine/core";
  ...
  return (
    ...
    >
      ...
      <MantineAppShell.Navbar p="md">
        ...
        <MantineAppShell.Section grow={true} my="md" component={ScrollArea}>
